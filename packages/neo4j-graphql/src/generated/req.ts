...
export const CreateAwesomeListsDocument = gql`
  ...
  createAwesomeLists(input: $input) {
    ...
    `;
export const CreateReposDocument = gql`
  ...
  createRepos(input: $input) {
    ...
    `;
export const ConnectRepoDocument = gql`
  ...
  updateRepos(connect: $connect) {
    ...
    `;
export const AwesomeListsDocument = gql`
...
export const ReposDocument = gql`
  ...
  repos(where: $where, options: $options) {
    ...
    `;
export const UpdateAwesomeListsDocument = gql`
  ...
  updateAwesomeLists(
    ...
    `;
export const UpdateReposDocument = gql`
...
const CreateAwesomeListsDocumentString = print(CreateAwesomeListsDocument);
const CreateReposDocumentString = print(CreateReposDocument);
const ConnectRepoDocumentString = print(ConnectRepoDocument);
const AwesomeListsDocumentString = print(AwesomeListsDocument);
const ReposDocumentString = print(ReposDocument);
const UpdateAwesomeListsDocumentString = print(UpdateAwesomeListsDocument);
const UpdateReposDocumentString = print(UpdateReposDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreateAwesomeLists(variables: CreateAwesomeListsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: CreateAwesomeListsMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreateAwesomeListsMutation>(CreateAwesomeListsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateAwesomeLists', 'mutation', variables);
    },
    CreateRepos(variables: CreateReposMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: CreateReposMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreateReposMutation>(CreateReposDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateRepos', 'mutation', variables);
    },
    connectRepo(variables?: ConnectRepoMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: ConnectRepoMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<ConnectRepoMutation>(ConnectRepoDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'connectRepo', 'mutation', variables);
    },
    AwesomeLists(variables?: AwesomeListsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: AwesomeListsQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<AwesomeListsQuery>(AwesomeListsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'AwesomeLists', 'query', variables);
    },
    Repos(variables?: ReposQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: ReposQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<ReposQuery>(ReposDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Repos', 'query', variables);
    },
    UpdateAwesomeLists(variables?: UpdateAwesomeListsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: UpdateAwesomeListsMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdateAwesomeListsMutation>(UpdateAwesomeListsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateAwesomeLists', 'mutation', variables);
    },
    UpdateRepos(variables?: UpdateReposMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: UpdateReposMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdateReposMutation>(UpdateReposDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateRepos', 'mutation', variables);
    }
  };
}
